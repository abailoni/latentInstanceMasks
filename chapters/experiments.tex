...
LFC+EffAff \cite{parag2017anisotropic} & \UPDATE{?} & 0.616  \\
        \end{tabular}
        \vspace*{0.99em}
    \caption{Representative excerpt of the published methods currently part of the CREMI leaderboard \cite{cremiChallenge} (March 2020). Partitioning algorithms that do not rely on super-pixels are marked with $\dagger$.}
