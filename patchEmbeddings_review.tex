...
% \begin{comment}
\titlerunning{Proposal-Free Instance Segmentation from Latent Single-Instance Masks}
% If the paper title is too long for the running head, you can set
% an abbreviated paper title here
%
\author{Alberto Bailoni\inst{1}\and
Constantin Pape\inst{2} \and
Steffen Wolf\inst{1} \and \\
Anna Kreshuk\inst{2} \and
Fred A. Hamprecht\inst{1}}
%
\authorrunning{A. Bailoni et al.}
% First names are abbreviated in the running head.
% If there are more than two authors, 'et al.' is used.
%
\institute{HCI/IWR, Heidelberg University, 69120 Heidelberg, Germany 
\email{\{name.surname\}@iwr.uni-heidelberg.de} \and
% \url{http://www.springer.com/gp/computer-science/lncs} \and
EMBL, 69117 Heidelberg, Germany\\
\email{\{name.surname\}@embl.de}}
% \end{comment}
%******************
\maketitle
